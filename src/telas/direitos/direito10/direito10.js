...
export default function Direito10() {
                ...
                <View style={styles.main}>
                    ...
                    <View style={{
                        ...
                        alignSelf: 'center',
                            ...
                            <Image source={require('../../../img/direitosGeral/imagem10.png')}
                                 style={[styles.univLogo, {top: 10}]} />


                        <View style={{ left: 5, top: 15 }}>
                            <Text style={{ width: 250, fontSize:18, fontWeight: 500, bottom: 15 }}>
                            Sessões Terapêuticas Ilimitadas para Pessoas Autistas (Resolução Normativa ANS nº 465/2021)
                            </Text>
                        </View>
                    </View>
