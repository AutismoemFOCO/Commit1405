...
export default function Direito08() {
                ...
                <View style={styles.main}>
                    ...
                    <View style={{
                        ...
                        alignSelf: 'center',
                            ...
                            <Image source={require('../../../img/direitosGeral/imagem8.png')}
                                style={styles.univLogo} />

                        <View style={{ left: 5, top: 15 }}>
                            <Text style={{ width: 250, fontSize:18, fontWeight: 500, bottom: 10, left: 10 }}>
