...
export default function Direito07() {
                ...
                <View style={styles.main}>
                    ...
                    <View style={{
                        ...
                        alignSelf: 'center',
                            ...
                            <Image source={require('../../../img/direitosGeral/imagem7.png')}
                                style={[styles.univLogo, {width: 85, height: 50, top: 20}]} />
