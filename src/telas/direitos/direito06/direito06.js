...
export default function Direito06() {
                ...
                <View style={styles.main}>
                    ...
                    <View style={{
                        ...
                        alignSelf: 'center',
                            ...
                            <Image source={require('../../../img/direitosGeral/imagem6.png')}
                                style={styles.univLogo} />

                        <View style={{ left: 5, top: 15 }}>
                            <Text style={{ width: 250, fontSize:18, fontWeight: 500 }}>
                                Direito à Apoio e Proteção às Pessoas com Deficiência
                            </Text>
                        </View>
                    </View>
