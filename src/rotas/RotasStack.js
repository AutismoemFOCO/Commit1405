            ...
            <Stack.Navigator screenOptions={{ headerShown: false }} initialRouteName='inicial'>
                ...
                <Stack.Screen
                    ...
                    initialParams={{
                        ...
                        categoriaText: 'Esta seção aborda comportamento característicos do autismo',
                        subcategorias: ['Hipersensibilidade', 'Esteriotipias', 'Socialização'],
                    }}
                />
                <Stack.Screen
                    name='Educação'
                    ...
                    initialParams={{
                        categoria: 'Educação',
                        categoriaText: '“Se a educação sozinha não transforma a sociedade, sem ela tampouco a sociedade muda.”                                                                                  -Paulo Freire',
                        subcategorias: ['Escola', 'Exatas', 'Humanas'],
                    }}
                />
                <Stack.Screen
                    name='Comorbidades'
                    ...
                    initialParams={{
                        ...
                        categoriaText: 'Texto explicativo sobre Saúde...',
                        subcategorias: ['Ansiedade', 'TDAH', 'TOC'],
                ...
                <Stack.Screen
                    ...
                    initialParams={{
                        categoria: 'Terapia',
                        categoriaText: 'Texto explicativo sobre Terapia...',
                        subcategorias: ['Fono', 'ABA', 'Fisoterapia',]
                    }}
                />
                <Stack.Screen
                    name='Indicações'
                    ...
                    initialParams={{
                        ...
                        categoriaText: 'Indicações de  filmes, séries e documentários sobre o autismo e redes socias, sites e canais do YouTube seguros e confiáveis.',
                        subcategorias: ['Filmes', 'Séries', 'Redes Sociais',]
                    }}
                />
